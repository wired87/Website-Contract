...
## Programmatische Erstellung einer modularen Website
...
Vertreten durch: __________________________________________  
Adresse: __________________________________________  
E-Mail: __________________________________________  
...
Der Auftragnehmer erstellt für den Auftraggeber eine **programmatische Website oder Website-Komponente auf Basis einer bereitgestellten Vorlage oder Spezifikation**.
...
Der Auftraggeber stellt rechtzeitig folgende Materialien bereit:
...
Nach vollständiger Bezahlung erhält der Auftraggeber das **nicht-exklusive, zeitlich unbegrenzte Nutzungsrecht** am erstellten Code zur Verwendung auf eigenen Websites oder digitalen Projekten.

Der Auftragnehmer bleibt berechtigt:

- generische Teile des Codes weiterzuverwenden  
- technische Komponenten in anderen Projekten einzusetzen  
- das Projekt als Referenz zu nennen, sofern keine vertraulichen Informationen offengelegt werden.
...
Gerichtsstand: __________________________________________
